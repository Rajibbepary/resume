    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="#">
                    <img src={assets.logo} alt="Logo" className="w-28 cursor-pointer mr-14 dark:hidden" />
                    <img src={assets.logo_dark} alt="Logo" className="w-28 cursor-pointer mr-14 hidden dark:block" />
                </a>
                ...
                <div className="flex items-center gap-4">
                    <button onClick={toggleTheme}>
                        <img src={assets.moon_icon} alt="" className="w-5 dark:hidden" />
                        <img src={assets.sun_icon} alt="" className="w-5 hidden dark:block" />
                    </button>
                    ...
                    <a href="#contact" className="hidden lg:flex items-center gap-3 px-8 py-1.5 border border-gray-300 hover:bg-slate-100/70 dark:hover:bg-darkHover rounded-full ml-4 font-Ovo dark:border-white/30">
                        Contact
                        <img src={assets.arrow_icon} alt="" className="w-3 dark:hidden" />
                        <img src={assets.arrow_icon_dark} alt="" className="w-3 hidden dark:block" />
                    </a>

                    <button className="block md:hidden ml-3" onClick={openMenu}>
                        <img src={assets.menu_black} alt="" className="w-6 dark:hidden" />
                        <img src={assets.menu_white} alt="" className="w-6 hidden dark:block" />
                    </button>
                ...
                <ul ref={sideMenuRef} className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 font-Ovo dark:bg-darkHover dark:text-white">
                    ...
                    <div className="absolute right-6 top-6" onClick={closeMenu}>
                        <img src={assets.close_black} alt="" className="w-5 cursor-pointer dark:hidden" />
                        <img src={assets.close_white} alt="" className="w-5 cursor-pointer hidden dark:block" />
                    </div>
